...
public class NearbyWords implements SpellingSuggest {
	...
	public void insertions(String s, List<String> currentList, boolean wordsOnly ) {
		...
		// for each index of the starting string and for each letter of the alphabet
		// insert a new character and check if it is a real word
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while(!queue.isEmpty() && numSuggestions > retList.size()){
			String current = queue.remove(0);
			List<String> oneAway = distanceOne(current,true);
			
			
			for (String s: oneAway){
