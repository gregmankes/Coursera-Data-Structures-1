...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double bd = profileBasicDocument(file, trials);
			double ed = profileEfficientDocument(file, trials);
			System.out.printf("%d\t%1.9f\t%1.9f\n",numToCheck,bd,ed);
		}
	...
	private static double profileBasicDocument(String file,int numTrials){
		...
		for (int i = 1; i <= numTrials; i++){
			...
			double deltaTime = (endTime-startTime)/1000000000.0;
			averageTime +=deltaTime;
		}
		return averageTime;
		
	}
	private static double profileEfficientDocument(String file,int numTrials){
		double averageTime = 0;
